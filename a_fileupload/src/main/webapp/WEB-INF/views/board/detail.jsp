...
<div class="container">
	...
	<table class="table">
		...
		<tr>
			...
			<c:if test="${not empty b.fileName and b.fileType eq 'IMAGE'}">
				<img src="${contextPath}/imgDisplay?fileName=${b.bno}/${b.fileName}" style="width: 500px">
			</c:if>	
	...
	<%-- <form action="${contextPath}/board/remove?bno=${b.bno}" method="post" enctype="multipart/form-data">
	<button class="btn btn-info delBtn">삭제</button>
	</form> --%>
