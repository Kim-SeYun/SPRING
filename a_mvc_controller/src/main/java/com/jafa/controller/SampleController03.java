...
public class SampleController03 {
	...
	// 파라미터 이름과 동일한 이름을 갖는 경로변수 사용
	// 요청경로가 /sample03/member/aaa일 경우
	// 파라미터 memberId에 aaa값이 전달된다.
	// 파라미터로 선언된 memberId는 뷰페이지에서 이름이 memberId로 사용할 수 있음
